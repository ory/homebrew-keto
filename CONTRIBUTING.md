...
# Contribute to Ory homebrew-keto<!-- omit in toc -->
...
_Please note_: We take Ory homebrew-keto's security and our users' trust very
seriously. If you believe you have found a security issue in Ory homebrew-keto,
...
homebrew-keto's direction. A great way to
do this is via
[Ory homebrew-keto Discussions](https://github.com/orgs/ory/discussions)
or the [Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/homebrew-keto/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory homebrew-keto?](#communication)
...
- I want to talk to other Ory homebrew-keto users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  homebrew-keto.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/homebrew-keto)

- I would like updates about new versions of Ory homebrew-keto.
...
[list of good first issues](https://github.com/ory/homebrew-keto/labels/good%20first%20issue).

There are many other ways you can contribute. Here are a few things you can do
to help out:

- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory homebrew-keto.
...
- **Help with open issues.** We have a lot of open issues for Ory homebrew-keto and
...
Check out [Ory homebrew-keto Discussions](https://github.com/orgs/ory/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory homebrew-keto,
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/homebrew-keto/blob/master/.github/workflows/conventional_commits.yml)
...
before getting started to ensure your work is consistent with Ory homebrew-keto's
...
[Contributor License Agreement](https://cla-assistant.io/ory/homebrew-keto).
...
git clone git@github.com:ory/ory/homebrew-keto.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/homebrew-keto.git
